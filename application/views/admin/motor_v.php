    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ul class="nav nav-tabs">
          <li class="active">
            <a href="#tbl_motor" data-toggle="tab" aria-expanded="true"> Tabel Motor </a>
          </li>

          <li>
            <a href="#tmbh_motor" data-toggle="tab" aria-expanded="true"> Form Tambah Motor </a>
          </li>
        </ul>
        ...
        <div class="tab-content">
          ...
          <!--TAB TABEL MOTOR-->
          <div class="tab-pane fade active in" id="tbl_motor">
            <form method="post" action="<?php echo base_url('index.php/admin/index/');?>" enctype="multipart/form-data" >
          ...
          <!--TAB TAMBAH MOTOR-->
          <div class="tab-pane fade" id="tmbh_motor">
            <form method="post" action="<?php echo base_url('index.php/admin/tambah_motor/');?>" enctype="multipart/form-data" >
              <div class="panel-body">
                <div class="col-lg-6">
                  <?php
                  $notif = $this->session->flashdata('notif');

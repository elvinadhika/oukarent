						...
						<form method="post" action="<?php echo base_url('index.php/admin/edit_car/');?>" enctype="multipart/form-data">
							<div class="col-lg-6">
								<div class="form-group">
                  				...
                  				<div class="form-group">
                       				<label>Door</label>
                        			<input class="form-control" type="text" name="door" value="<?php echo $data->door?>" required>
                  				</div>

                  				<div class="form-group">
                        			<label>Seats</label>
                        			<input class="form-control" type="text" name="seats" value="<?php echo $data->seats?>" required>
                  				</div>
